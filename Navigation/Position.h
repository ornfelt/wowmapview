...
struct Position
{
    ...
    [[nodiscard]] void SetPositionX(float value) { m_positionX = value; }
    [[nodiscard]] void SetPositionY(float value) { m_positionY = value; }
    [[nodiscard]] void SetPositionZ(float value) { m_positionZ = value; }
