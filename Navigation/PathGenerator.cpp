...
PathGenerator::PathGenerator(WorldObject const* owner, unsigned int mapId, unsigned int instanceId) :
...
bool PathGenerator::CalculatePath(float x, float y, float z, float destX, float destY, float destZ, bool forceDest)
{
    ...
    {
        std::cout << "NOT VALID CORD (pathgen)" << std::endl;
        return false;
    }
...
void PathGenerator::NormalizePath()
{
    ...
    {
        // Doesn't work if only mmaps is loaded (see CalculatePath in Pathing.cpp or DllMain.cpp)
